package com.cgpc.feb26.linkedlist;

import java.util.Scanner;

public class SimpleDoublyLinkedListDemo1 {
	...
	private boolean deleteByValue(int value) {
	...
	public static void main(String[] args) {
		...
		SimpleDoublyLinkedListDemo1 list = new SimpleDoublyLinkedListDemo1();
